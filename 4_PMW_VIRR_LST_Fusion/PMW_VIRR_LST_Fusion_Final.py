...
if __name__ == '__main__':
    ...
    model_dir = os.path.join(data_dir, 'Sub_to_25km', 'PMW_VIRR_Fusion_LST')  # 指向新训练的模型目录
    output_dir = os.path.join(data_dir, 'Global_1km_Fusion_LST')
    ...
    for dekad_num in range(1, 37):
        ...
        try:
            model_file = os.path.join(model_dir, f"PMW_VIRR_Fusion_LST_D{dekad_num:02d}.joblib")
